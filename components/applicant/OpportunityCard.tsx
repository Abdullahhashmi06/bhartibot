...
export default function OpportunityCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-2 mt-5 mb-6">          <span className={`inline-flex items-center gap-1.5 rounded-lg border px-2.5 py-1 text-[11px] font-semibold ${compClasses}`}>
            {competition.dot} {competition.label}
          </span>
