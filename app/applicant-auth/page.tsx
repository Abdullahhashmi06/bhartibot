...
export default function ApplicantAuthPage() {
  ...
  if (otpStep) {
    return (
      <Shell>
        <div className="min-h-[calc(100vh-160px)] bg-background flex flex-col justify-center items-center p-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-card border border-border dark:border-slate-700"
          >
            <div className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-2xl font-display font-bold text-primary dark:text-white">Verify Code</h1>
              <p className="text-text-secondary dark:text-slate-300 text-sm mt-1 text-center">
                Enter the verification code sent to<br />
                <span className="font-semibold text-primary dark:text-white">{email}</span>
              </p>
            </div>
            ...
            >
              <div className="space-y-2">
                <label className="text-sm font-medium text-primary dark:text-white">6-Digit Code</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2 rounded-xl border border-border dark:border-slate-600 dark:bg-slate-800 dark:text-white focus:border-teal focus:ring-1 focus:ring-teal outline-none transition-all text-center text-2xl font-mono tracking-[0.3em]"
                    placeholder="000000"
                  />
                </div>
              </div>
            ...
            <div className="mt-4 text-center">
              <button
                ...
                className="text-xs text-text-secondary dark:text-slate-400 hover:text-primary dark:hover:text-white transition-colors inline-flex items-center gap-1"
              >
      ...
      <div className="min-h-[calc(100vh-160px)] bg-background flex flex-col justify-center items-center p-4">
        ...
        >
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-display font-bold text-primary dark:text-white">InternIQ Portal</h1>
          ...
          {!useOtp && !isForgotPassword && (
            <div className="mb-6 space-y-6">
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 rounded-xl border border-border dark:border-slate-600 bg-white dark:bg-slate-800 px-4 py-3 text-sm font-semibold text-text-primary dark:text-white hover:bg-slate-50 dark:hover:bg-slate-700 hover:shadow-subtle transition-all disabled:opacity-50"
              >
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-white dark:bg-slate-900 px-4 text-text-muted dark:text-slate-400 font-medium">or continue with email</span>
                </div>
              </div>
            </div>
          )}
          ...
          {isForgotPassword ? (
            <form onSubmit={handleForgotPassword} className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-primary dark:text-white">Email Address</label>
                <div className="relative">
            ...
            <form onSubmit={handlePasswordAuth} className="space-y-4">
              {!isLogin && (
                <div className="space-y-2">
                  <label className="text-sm font-medium text-primary dark:text-white">Full Name</label>
                  <div className="relative">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-primary dark:text-white">Password</label>
                <div className="relative">
                ...
                <div className="flex flex-col gap-3 mt-4">
                  <div className="text-center">
                    <button
                      ...
                      className="text-xs text-text-secondary dark:text-slate-400 hover:text-primary dark:hover:text-white font-medium hover:underline"
                    >
                  ...
                  <div className="text-center">
                    <button
                      ...
                      className="text-xs text-teal dark:text-teal-400 font-medium hover:underline"
                    >
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <button
              onClick={toggleMode}
              className="text-teal dark:text-teal-400 font-medium hover:underline"
            >
